...
const StaffList: React.FC<{ personnel: PersonnelProfile[], jobRoles: JobRole[], filterText: string, onViewDetails: (p: PersonnelProfile) => void, onEdit: (p: PersonnelProfile) => void, onDelete: (id: string) => void }> = ({ personnel, jobRoles, filterText, onViewDetails, onEdit, onDelete }) => {
        ...
        <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
                {filteredPersonnel.length > 0 ? filteredPersonnel.map(person => {
                    ...
                    return (<tr key={person.id} className="hover:bg-gray-50">
